...
return [
    'ctrl' => [
        ...
        'searchFields'             => 'uuid,forename,surname,corporateName',
        'enablecolumns'            => [
            'disabled' => 'hidden',
            'fe_group' => 'fe_group',
        ],
    ...
    'columns' => [
        ...
        'l18n_parent' => [
            ...
            'config'      => [
                ...
                'foreign_table_where' =>
                    'AND {#tx_dalex_domain_model_contributor}.{#pid}=###CURRENT_PID###'
    ...
    'types' => [
        '0' => [
            'showitem' => 'hidden,uuidActive,surnameForename,corporateName,label,sameAs,',
        ],
    ],
];
