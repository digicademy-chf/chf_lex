...
return [
    'ctrl' => [
        'title'                    => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry',
        'label'                    => 'headword',
        'tstamp'                   => 'tstamp',
        'crdate'                   => 'crdate',
        'delete'                   => 'deleted',
        ...
        'searchFields'             => 'uuid,headword,homographNumber,editorialQuery,editorialSteps,publicationSteps,publicationDate,revisionNumber,revisionDate,editorialNote,importOrigin,import',
        'enablecolumns'            => [
            'disabled' => 'hidden',
            'starttime' => 'starttime',
            'endtime' => 'endtime',
    ...
    'columns' => [
        ...
        'headword' => [
            'exclude' => true,
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.headword',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.headword.description',
            'config' => [
                'type' => 'input',
                'size' => 40,
                'max' => 255,
        ...
        'homographNumber' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.homographNumber',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.homographNumber.description',
            'config' => [
                'type' => 'number',
                'size' => 13,
                'range' => [
        ...
        'partOfSpeech' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.partOfSpeech',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.partOfSpeech.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
        ...
        'editorialQuery' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.editorialQuery',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.editorialQuery.description',
            'config' => [
                'type' => 'input',
                'size' => 40,
                'max' => 255,
        ...
        'editorialSteps' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectCheckBox',
                'items' => [
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.toggle',
                        'value' => '--div--',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkDatabase',
                        'value' => 'checkDatabase',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkForeignLanguage',
                        'value' => 'checkForeignLanguage',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkRegional',
                        'value' => 'checkRegional',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkPrevious',
                        'value' => 'checkPrevious',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkFurther',
                        'value' => 'checkFurther',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.editorialSteps.checkMaps',
                        'value' => 'checkMaps',
                    ],
                ],
                'appearance' => [
        ...
        'publicationSteps' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectCheckBox',
                'items' => [
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.toggle',
                        'value' => '--div--',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.started',
                        'value' => 'started',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.edited',
                        'value' => 'edited',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.checked',
                        'value' => 'checked',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.deferred',
                        'value' => 'deferred',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.revised',
                        'value' => 'revised',
                    ],
                    [
                        'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.publicationSteps.publicationReady',
        ...
        'sense' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.sense',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.sense.description',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_chflex_domain_model_sense',
                'foreign_field' => 'parentEntry',
                'appearance' => [
                    'collapseAll' => true,
                    'expandSingle' => true,
                    'newRecordLinkAddTitle' => true,
        ...
        'example' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.example',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.example.description',
            'config' => [
                'type' => 'inline',
        ...
        'frequency' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.frequency',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.frequency.description',
            'config' => [
                'type' => 'inline',
        ...
        'pronunciation' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.pronunciation',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.pronunciation.description',
            'config' => [
                'type' => 'inline',
        ...
        'inflectedForm' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.inflectedForm',
        ...
        'similarityRelation' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.similarityRelation',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.similarityRelation.description',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_chfbase_domain_model_relation',
                'foreign_table_where' => 'AND {#tx_chfbase_domain_model_relation}.{#pid}=###CURRENT_PID###'
        ...
        'asRefOfMember' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.asRefOfMember',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.asRefOfMember.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
        ...
        'asRelatedRecordOfSimilarityRelation' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.asRelatedRecordOfSimilarityRelation',
            'description' => 'LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.abstractEntry.asRelatedRecordOfSimilarityRelation.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_chfbase_domain_model_relation',
    ...
    'palettes' => [
        ...
        'headwordPartOfSpeechHomographNumber' => [
            'showitem' => 'headword,partOfSpeech,--linebreak--,homographNumber,',
        ],
        'parentResourceLabel' => [
        ...
        'editorialQueryEditorialStepsPublicationSteps' => [
            'showitem' => 'editorialQuery,--linebreak--,editorialSteps,--linebreak--,publicationSteps,',
        ],
    ...
    'types' => [
        '0' => [
            'showitem' => '--palette--;;isHighlightUuid,--palette--;;headwordPartOfSpeechHomographNumber,--palette--;;parentResourceLabel,sameAs,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.editorial,--palette--;;authorshipRelationLicenceRelation,--palette--;;editorialQueryEditorialStepsPublicationSteps,--palette--;;publicationDateRevisionDateRevisionNumberEditorialNote,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.content,sense,--palette--;;contentElementFootnote,--palette--;;mediaFile,
            --div--;LLL:EXT:chf_lex/Resources/Private/Language/locallang.xlf:object.dictionaryEntry.details,--palette--;;exampleFrequency,pronunciation,inflectedForm,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.relations,similarityRelation,linkRelation,publicationRelation,sourceRelation,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.import,--palette--;;importOriginImport,
            --div--;LLL:EXT:chf_base/Resources/Private/Language/locallang.xlf:object.generic.usage,asRefOfMember,asRelatedRecordOfSimilarityRelation,',
        ],
    ],
];
